...
const ModalCart = (props) => {
   ...
   /* DESTRUCTURING */
   const {openModal, toggleModal, infoProduct} = props;

   return ReactDOM.createPortal(
      openModal &&
      <div className={styles.container}>
         <div className={styles.topSide}>
            <h2>Product added successfully <span>&#129395;</span></h2>
            <button
               onClick={() => toggleModal()}
            >
               X
         ...
         <div className={styles.detail}>
            <div className={styles.detailProduct}>
               <img src={`https:${infoProduct.images[0].split('?')[0]}`} alt="" width={100}/>
               <div className={styles.detailProductInfo}>
                  <h2>{infoProduct.title}</h2>
                  <h4 className={styles.property}>Color: <span>Red</span></h4>
                  <h4 className={styles.property}>Size: <span>8.5</span></h4>
                  <h4 className={styles.property}>Quantity: <span>1</span></h4>
               </div>
            </div>
            <div className={styles.detailPrice}>
               ...
               <div className={styles.detailPriceInfo}>
                  ...
                  <div>
                     ...
                     <span>$ {infoProduct.compare_at_price - infoProduct.price}</span>
                  </div>
